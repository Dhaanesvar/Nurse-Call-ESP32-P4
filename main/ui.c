...
void ui_init(void)
{
    ...
    ui_Emergency_Panel_screen_init();
    ui_Call_Panel_screen_init();
    ui_Code_Blue_Panel_screen_init();
    ui_Toilet_Emergency_Panel_screen_init();
...
void ui_destroy(void)
{
    ...
    ui_Emergency_Panel_screen_destroy();
    ui_Call_Panel_screen_destroy();
    ui_Code_Blue_Panel_screen_destroy();
    ui_Toilet_Emergency_Panel_screen_destroy();
}
...
void ui_relocalize(void)
{
    ...
    ui_Emergency_Panel_screen_relocalize();
    ui_Call_Panel_screen_relocalize();
    ui_Code_Blue_Panel_screen_relocalize();
    ui_Toilet_Emergency_Panel_screen_relocalize();
}
